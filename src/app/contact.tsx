                ...
                <div className="flex rounded-md bg-gray-800 outline outline-1 -outline-offset-1 outline-gray-700 has-[input:focus-within]:outline has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-blue-400">
                  <div className="grid shrink-0 grid-cols-1 focus-within:relative">
                    <select
                      ...
                      aria-label="Country"
                      className="col-start-1 row-start-1 w-full appearance-none rounded-l-md py-2 pl-3.5 pr-7 text-base bg-gray-800 text-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-blue-400"
                    >
                      <option>US</option>
                      <option>CA</option>
                      <option>EU</option>
                    ...
                    <ChevronDownIcon
                      aria-hidden="true"
                      className="pointer-events-none col-start-1 row-start-1 mr-2 size-5 self-center justify-self-end text-gray-300 sm:size-4"
                    />
                  </div>
                  <input
                    id="phone-number"
                    ...
                    className="block min-w-0 grow py-1.5 pl-1 pr-3 text-base bg-gray-800 text-gray-200 placeholder:text-gray-400 focus:outline focus:outline-0 rounded-r-md"
                  />
                </div>
              </div>
            </div>
