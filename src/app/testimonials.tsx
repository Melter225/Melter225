...
export default function Testimonials() {
  ...
  return (
    <div className="flex w-[200rem] h-[12rem] items-center justify-center gap-x-5">
      {testimonials.map(({ src, alt, name, username, testimonial }, index) => (
        <div
          key={`${index}`}
          className="flex flex-col justify-center w-[22rem] h-[12rem] bg-neutral-800 rounded-xl shadow-xl shadow-gray-800 border-2 border-neutral-800"
        >
